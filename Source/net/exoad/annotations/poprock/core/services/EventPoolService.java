...
import net.exoad.annotations.poprock.core.Pair;
 ...
 * {@link EventPoolService.EventPayload}).
 * <p>
 ...
 * <p>
 * <h3>Event Pools are ephemeral</h3>. If you are using Poprock as
 * a library and never call
 * {@link pkg.exoad.app.AppEntry#main(String[])}, your {@code 1}
 * event pool might not be the same as the one found in the default Poprock
 * app. For example, in the Poprock App, event pool {@code 1} represents a
 ...
 * {@link
 * EventPoolService.EventPool#isRegisteredPayloadID(Class)}
 *
 * <blockquote><pre>
 * EventPool
 * .getPool(1)

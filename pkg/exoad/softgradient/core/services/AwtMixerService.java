 ...
 * {@link java.awt.Dimension}, you can easily just use SoftGradient's core
 * {@link pkg.exoad.softgradient.core.Size} when importing
 * {@link pkg.exoad.softgradient.core}
 *
 * @author Jack Meng
 */
public final class AwtMixerService
{
	...
	/**
	 * Converts from an AWT Point class to a SoftGradient Offset class which is

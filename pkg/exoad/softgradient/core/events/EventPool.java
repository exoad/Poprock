 ...
 * implements {@link pkg.exoad.softgradient.core.events.EventPayload}).
 * <p>
 ...
 * {@link pkg.exoad.softgradient.SoftGradientEntry#main(String[])}, your
                             ...
                             DebuggableMixin
{
       ...
       * <p>
       * <strong>This function has a chance to panic if the requested ID to
       ...
       * @param id identifier of the payload
       */
      public final synchronized <T extends EventPayload> void ping(Class<T> id)      // should be called sparingly please!!
      ...
      public <T extends EventPayload> boolean isRegisteredPayloadID(Class<T> id)
      {
